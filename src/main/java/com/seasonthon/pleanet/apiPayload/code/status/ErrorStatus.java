...
public enum ErrorStatus implements BaseErrorCode {
    ...
    _PHOTO_URL_NOT_FOUND(HttpStatus.BAD_REQUEST, "PHOTO401", "인증할 사진 URL이 없습니다."),

    // External API Errors (e.g., OpenAI)
    _OPENAI_API_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "EXTERNAL500", "사진 분석 AI 서버 호출에 실패했습니다."),
